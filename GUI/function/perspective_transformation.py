...
def transformation_image(pic_path: str, output_path: str, flip_vertical=False, loc='left') -> np.ndarray:
    ...
    if loc == 'right':
        ...
        a_2 = 220  # 影響左側的左右
        a_3 = 3850  # 影響右側的左右
        p1 = np.float32([[a_2, a_1], [a_2, 3000 - a_1], [a_3, 0], [a_3, 2900]])

        b_1 = 0
        b_2 = 0  # 影響右側的上下
        b_3 = 3900
        p2 = np.float32([[b_1, 0], [b_1, 2800], [b_3, b_2], [4000, 3000 - b_2]])
