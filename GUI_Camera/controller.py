...
class MainWindow_controller(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.grabber, self.sink, self.display = self.create_display('left')
        self.grabber2, self.sink2, self.display2 = self.create_display('right')
    ...
    def open_cam(self, location: str):
        ...
        if location == 'left':
            ...
            self.grabber2.stream_setup(self.sink2, self.display2)
    ...
    def save_image(self, location: str):  # 取得影像  # data 為接收到的影像
        try:
            ...
            if location == 'left':
                image = self.sink.snap_single(2000)
                ...
                image = self.sink2.snap_single(2000)
                # Print image information.
